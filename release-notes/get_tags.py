...
def get_tags_for_release_notes(previous_tag, current_tag, pattern=None):
    ...
    try:
        ...
        tags = git("for-each-ref", "--sort", "creatordate", "--format", "%(tag)", tags_refs).decode().strip()
...
get_tags_for_release_notes('v0.0.1', 'v1.0.0', 'v[0-9]*')
